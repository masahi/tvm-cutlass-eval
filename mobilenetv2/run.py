...
sm  = 80
model = torchvision.models.mobilenet.mobilenet_v2(pretrained=True).eval()
input_name = "input0"
...
# print(mod)
# rt_mod, dev, num_partition = profile_and_build(mod, params, sm, tmp_dir="../maskrcnn/tmp", lib_path="compile_mv2.so", precompiled=False)
